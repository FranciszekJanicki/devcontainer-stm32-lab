...
HAL_StatusTypeDef
HAL_LTDC_ConfigCLUT(LTDC_HandleTypeDef* hltdc, const uint32_t* pCLUT, uint32_t CLUTSize, uint32_t LayerIdx);
...
#define IS_LTDC_BLENDING_FACTOR2(__BLENDING_FACTOR1__) \
    (((__BLENDING_FACTOR1__) == LTDC_BLENDING_FACTOR2_CA) || ((__BLENDING_FACTOR1__) == LTDC_BLENDING_FACTOR2_PAxCA))
