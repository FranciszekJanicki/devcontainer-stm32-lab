...
#define ADC_CHANNEL_DAC1CH1                                                \
    (LL_ADC_CHANNEL_DAC1CH1) /*!< Internal channel DAC1 channel 1,         \
...
#define ADC_CHANNEL_DAC1CH2                                          \
    (LL_ADC_CHANNEL_DAC1CH2) /*!< Internal channel DAC1 channel 2,   \
...
#define ADC_CHANNEL_DAC1CH1_ADC2                                        \
    (LL_ADC_CHANNEL_DAC1CH1_ADC2) /*!< Internal channel DAC1 channel 1, \
  channel specific to ADC2 */
#define ADC_CHANNEL_DAC1CH2_ADC2                                        \
    (LL_ADC_CHANNEL_DAC1CH2_ADC2) /*!< Internal channel DAC1 channel 2, \
  channel specific to ADC2 */
#if defined(ADC3)
#define ADC_CHANNEL_DAC1CH1_ADC3                                        \
    (LL_ADC_CHANNEL_DAC1CH1_ADC3) /*!< Internal channel DAC1 channel 1, \
  channel specific to ADC3 */
#define ADC_CHANNEL_DAC1CH2_ADC3                                        \
    (LL_ADC_CHANNEL_DAC1CH2_ADC3) /*!< Internal channel DAC1 channel 2, \
  channel specific to ADC3 */
#endif                            /* ADC3 */
#endif                            /* ADC1 && !ADC2 */
/**
