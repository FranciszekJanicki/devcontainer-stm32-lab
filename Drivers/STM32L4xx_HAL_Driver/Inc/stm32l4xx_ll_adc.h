...
#define ADC_CR_BITS_PROPERTY_RS                                                                     \
    (ADC_CR_ADCAL | ADC_CR_ADEN | ADC_CR_ADDIS | ADC_CR_JADSTART | ADC_CR_JADSTP | ADC_CR_ADSTART | \
...
#define TEMPSENSOR_CAL1_ADDR                                                 \
    ((uint16_t*)(0x1FFF75A8UL)) /* Address of parameter TS_CAL1: On STM32L4, \
   temperature sensor ADC raw data acquired at temperature  30 DegC          \
   (tolerance: +-5 DegC), Vref+ = 3.0 V (tolerance: +-10 mV). */
#define TEMPSENSOR_CAL2_ADDR                                                 \
    ((uint16_t*)(0x1FFF75CAUL)) /* Address of parameter TS_CAL2: On STM32L4, \
...
#define TEMPSENSOR_CAL1_TEMP                                         \
    ((int32_t)30L) /* Temperature at which temperature sensor        \
...
#define LL_ADC_CHANNEL_0 \
    (ADC_CHANNEL_0_NUMBER | ADC_CHANNEL_0_SMP | ADC_CHANNEL_0_BITFIELD) /*!< ADC channel ADCx_IN0 */
#define LL_ADC_CHANNEL_1 \
    (ADC_CHANNEL_1_NUMBER | ADC_CHANNEL_1_SMP | ADC_CHANNEL_1_BITFIELD) /*!< ADC channel ADCx_IN1 */
#define LL_ADC_CHANNEL_2 \
    (ADC_CHANNEL_2_NUMBER | ADC_CHANNEL_2_SMP | ADC_CHANNEL_2_BITFIELD) /*!< ADC channel ADCx_IN2 */
#define LL_ADC_CHANNEL_3 \
    (ADC_CHANNEL_3_NUMBER | ADC_CHANNEL_3_SMP | ADC_CHANNEL_3_BITFIELD) /*!< ADC channel ADCx_IN3 */
#define LL_ADC_CHANNEL_4 \
    (ADC_CHANNEL_4_NUMBER | ADC_CHANNEL_4_SMP | ADC_CHANNEL_4_BITFIELD) /*!< ADC channel ADCx_IN4 */
#define LL_ADC_CHANNEL_5 \
    (ADC_CHANNEL_5_NUMBER | ADC_CHANNEL_5_SMP | ADC_CHANNEL_5_BITFIELD) /*!< ADC channel ADCx_IN5 */
#define LL_ADC_CHANNEL_6 \
    (ADC_CHANNEL_6_NUMBER | ADC_CHANNEL_6_SMP | ADC_CHANNEL_6_BITFIELD) /*!< ADC channel ADCx_IN6 */
#define LL_ADC_CHANNEL_7 \
    (ADC_CHANNEL_7_NUMBER | ADC_CHANNEL_7_SMP | ADC_CHANNEL_7_BITFIELD) /*!< ADC channel ADCx_IN7 */
#define LL_ADC_CHANNEL_8 \
    (ADC_CHANNEL_8_NUMBER | ADC_CHANNEL_8_SMP | ADC_CHANNEL_8_BITFIELD) /*!< ADC channel ADCx_IN8 */
#define LL_ADC_CHANNEL_9 \
    (ADC_CHANNEL_9_NUMBER | ADC_CHANNEL_9_SMP | ADC_CHANNEL_9_BITFIELD) /*!< ADC channel ADCx_IN9 */
#define LL_ADC_CHANNEL_10 \
    (ADC_CHANNEL_10_NUMBER | ADC_CHANNEL_10_SMP | ADC_CHANNEL_10_BITFIELD) /*!< ADC channel ADCx_IN10 */
#define LL_ADC_CHANNEL_11 \
    (ADC_CHANNEL_11_NUMBER | ADC_CHANNEL_11_SMP | ADC_CHANNEL_11_BITFIELD) /*!< ADC channel ADCx_IN11 */
#define LL_ADC_CHANNEL_12 \
    (ADC_CHANNEL_12_NUMBER | ADC_CHANNEL_12_SMP | ADC_CHANNEL_12_BITFIELD) /*!< ADC channel ADCx_IN12 */
#define LL_ADC_CHANNEL_13 \
    (ADC_CHANNEL_13_NUMBER | ADC_CHANNEL_13_SMP | ADC_CHANNEL_13_BITFIELD) /*!< ADC channel ADCx_IN13 */
#define LL_ADC_CHANNEL_14 \
    (ADC_CHANNEL_14_NUMBER | ADC_CHANNEL_14_SMP | ADC_CHANNEL_14_BITFIELD) /*!< ADC channel ADCx_IN14 */
#define LL_ADC_CHANNEL_15 \
    (ADC_CHANNEL_15_NUMBER | ADC_CHANNEL_15_SMP | ADC_CHANNEL_15_BITFIELD) /*!< ADC channel ADCx_IN15 */
#define LL_ADC_CHANNEL_16 \
    (ADC_CHANNEL_16_NUMBER | ADC_CHANNEL_16_SMP | ADC_CHANNEL_16_BITFIELD) /*!< ADC channel ADCx_IN16 */
#define LL_ADC_CHANNEL_17 \
    (ADC_CHANNEL_17_NUMBER | ADC_CHANNEL_17_SMP | ADC_CHANNEL_17_BITFIELD) /*!< ADC channel ADCx_IN17 */
#define LL_ADC_CHANNEL_18 \
    (ADC_CHANNEL_18_NUMBER | ADC_CHANNEL_18_SMP | ADC_CHANNEL_18_BITFIELD) /*!< ADC channel ADCx_IN18 */
#define LL_ADC_CHANNEL_VREFINT                                                \
    (LL_ADC_CHANNEL_0 | ADC_CHANNEL_ID_INTERNAL_CH) /*!< ADC internal channel \
...
#define LL_ADC_CHANNEL_DAC1CH1                                                                                \
    (LL_ADC_CHANNEL_17 | ADC_CHANNEL_ID_INTERNAL_CH | ADC_CHANNEL_ID_INTERNAL_CH_2) /*!< ADC internal channel \
...
#define LL_ADC_CHANNEL_DAC1CH2_ADC3                                            \
    (LL_ADC_CHANNEL_15 | ADC_CHANNEL_ID_INTERNAL_CH) /*!< ADC internal channel \
...
#define LL_ADC_REG_TRIG_EXT_TIM1_TRGO                                                              \
    (ADC_CFGR_EXTSEL_3 | ADC_CFGR_EXTSEL_0 | ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular \
...
#define LL_ADC_REG_TRIG_EXT_TIM1_TRGO2                                                             \
    (ADC_CFGR_EXTSEL_3 | ADC_CFGR_EXTSEL_1 | ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular \
...
#define LL_ADC_REG_TRIG_EXT_TIM2_TRGO                                                                                  \
    (ADC_CFGR_EXTSEL_3 | ADC_CFGR_EXTSEL_1 | ADC_CFGR_EXTSEL_0 | ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular \
                                          conversion trigger from external peripheral: TIM2 TRGO. Trigger edge set to  \
                                          rising edge (default setting). */
#define LL_ADC_REG_TRIG_EXT_TIM2_CH2                                                               \
    (ADC_CFGR_EXTSEL_1 | ADC_CFGR_EXTSEL_0 | ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular \
...
#define LL_ADC_REG_TRIG_EXT_TIM4_TRGO                                                              \
    (ADC_CFGR_EXTSEL_3 | ADC_CFGR_EXTSEL_2 | ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular \
                      conversion trigger from external peripheral: TIM4 TRGO. Trigger edge set to  \
                      rising edge (default setting). */
#define LL_ADC_REG_TRIG_EXT_TIM4_CH4                                                               \
    (ADC_CFGR_EXTSEL_2 | ADC_CFGR_EXTSEL_0 | ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular \
...
#define LL_ADC_REG_TRIG_EXT_TIM6_TRGO                                                                                  \
    (ADC_CFGR_EXTSEL_3 | ADC_CFGR_EXTSEL_2 | ADC_CFGR_EXTSEL_0 | ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular \
                                          conversion trigger from external peripheral: TIM6 TRGO. Trigger edge set to  \
                                          rising edge (default setting). */
#define LL_ADC_REG_TRIG_EXT_TIM8_TRGO                                                                                  \
    (ADC_CFGR_EXTSEL_2 | ADC_CFGR_EXTSEL_1 | ADC_CFGR_EXTSEL_0 | ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular \
...
#define LL_ADC_REG_TRIG_EXT_TIM15_TRGO                                                                                 \
    (ADC_CFGR_EXTSEL_3 | ADC_CFGR_EXTSEL_2 | ADC_CFGR_EXTSEL_1 | ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular \
                                          conversion trigger from external peripheral: TIM15 TRGO. Trigger edge set to \
                                          rising edge (default setting). */
#define LL_ADC_REG_TRIG_EXT_EXTI_LINE11                                                            \
    (ADC_CFGR_EXTSEL_2 | ADC_CFGR_EXTSEL_1 | ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular \
...
#define LL_ADC_REG_DFSDM_TRANSFER_ENABLE                                      \
    (ADC_CFGR_DFSDMCFG) /*!< ADC conversion data are transferred to DFSDM for \
...
#define LL_ADC_REG_SEQ_SCAN_ENABLE_16RANKS                                                              \
    (ADC_SQR1_L_3 | ADC_SQR1_L_2 | ADC_SQR1_L_1 | ADC_SQR1_L_0) /*!< ADC group regular sequencer enable \
...
#define LL_ADC_REG_SEQ_DISCONT_4RANKS                                                            \
    (ADC_CFGR_DISCNUM_1 | ADC_CFGR_DISCNUM_0 | ADC_CFGR_DISCEN) /*!< ADC group regular sequencer \
...
#define LL_ADC_REG_SEQ_DISCONT_6RANKS                                                            \
    (ADC_CFGR_DISCNUM_2 | ADC_CFGR_DISCNUM_0 | ADC_CFGR_DISCEN) /*!< ADC group regular sequencer \
                      discontinuous mode enable with sequence interruption every 6 ranks */
#define LL_ADC_REG_SEQ_DISCONT_7RANKS                                                            \
    (ADC_CFGR_DISCNUM_2 | ADC_CFGR_DISCNUM_1 | ADC_CFGR_DISCEN) /*!< ADC group regular sequencer \
                      discontinuous mode enable with sequence interruption every 7 ranks */
#define LL_ADC_REG_SEQ_DISCONT_8RANKS                                                                                 \
    (ADC_CFGR_DISCNUM_2 | ADC_CFGR_DISCNUM_1 | ADC_CFGR_DISCNUM_0 | ADC_CFGR_DISCEN) /*!< ADC group regular sequencer \
...
#define LL_ADC_INJ_TRIG_EXT_TIM2_CH1                                                                  \
    (ADC_JSQR_JEXTSEL_1 | ADC_JSQR_JEXTSEL_0 | ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected \
                        conversion trigger from external peripheral: TIM2 channel 1 event (capture    \
                        compare: input capture or output capture). Trigger edge set to rising edge    \
                        (default setting). */
#define LL_ADC_INJ_TRIG_EXT_TIM3_TRGO                                                                 \
    (ADC_JSQR_JEXTSEL_3 | ADC_JSQR_JEXTSEL_2 | ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected \
                        conversion trigger from external peripheral: TIM3 TRGO. Trigger edge set to   \
                        rising edge (default setting). */
#define LL_ADC_INJ_TRIG_EXT_TIM3_CH1                                                                              \
    (ADC_JSQR_JEXTSEL_3 | ADC_JSQR_JEXTSEL_2 | ADC_JSQR_JEXTSEL_0 | ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group \
                                             injected conversion trigger from external peripheral: TIM3 channel 1                                                      \
...
#define LL_ADC_INJ_TRIG_EXT_TIM3_CH3                                                                              \
    (ADC_JSQR_JEXTSEL_3 | ADC_JSQR_JEXTSEL_1 | ADC_JSQR_JEXTSEL_0 | ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group \
                                             injected conversion trigger from external peripheral: TIM3 channel 3                                                      \
                                             event (capture compare: input capture or output capture). Trigger edge                                                          \
                                             set to rising edge (default setting). */
...
#define LL_ADC_INJ_TRIG_EXT_TIM4_TRGO                                                                 \
    (ADC_JSQR_JEXTSEL_2 | ADC_JSQR_JEXTSEL_0 | ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected \
                        conversion trigger from external peripheral: TIM4 TRGO. Trigger edge set to   \
                        rising edge (default setting). */
#define LL_ADC_INJ_TRIG_EXT_TIM6_TRGO                                                                             \
    (ADC_JSQR_JEXTSEL_3 | ADC_JSQR_JEXTSEL_2 | ADC_JSQR_JEXTSEL_1 | ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group \
                                             injected conversion trigger from external peripheral: TIM6 TRGO. Trigger                                                  \
                                             edge set to rising edge (default setting). */
#define LL_ADC_INJ_TRIG_EXT_TIM8_CH4                                                                              \
    (ADC_JSQR_JEXTSEL_2 | ADC_JSQR_JEXTSEL_1 | ADC_JSQR_JEXTSEL_0 | ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group \
                                             injected conversion trigger from external peripheral: TIM8 channel 4                                                      \
                                             event (capture compare: input capture or output capture). Trigger edge                                                          \
                                             set to rising edge (default setting). */
#define LL_ADC_INJ_TRIG_EXT_TIM8_TRGO                                                                 \
    (ADC_JSQR_JEXTSEL_3 | ADC_JSQR_JEXTSEL_0 | ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected \
                        conversion trigger from external peripheral: TIM8 TRGO. Trigger edge set to   \
                        rising edge (default setting). */
#define LL_ADC_INJ_TRIG_EXT_TIM8_TRGO2                                                                \
    (ADC_JSQR_JEXTSEL_3 | ADC_JSQR_JEXTSEL_1 | ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected \
                        conversion trigger from external peripheral: TIM8 TRGO2. Trigger edge set to  \
                        rising edge (default setting). */
...
#define LL_ADC_INJ_TRIG_EXT_EXTI_LINE15                                                               \
    (ADC_JSQR_JEXTSEL_2 | ADC_JSQR_JEXTSEL_1 | ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected \
...
#define LL_ADC_INJ_RANK_1 \
    (ADC_JDR1_REGOFFSET | ADC_INJ_RANK_1_JSQR_BITOFFSET_POS) /*!< ADC group inj. sequencer rank 1 */
#define LL_ADC_INJ_RANK_2 \
    (ADC_JDR2_REGOFFSET | ADC_INJ_RANK_2_JSQR_BITOFFSET_POS) /*!< ADC group inj. sequencer rank 2 */
#define LL_ADC_INJ_RANK_3 \
    (ADC_JDR3_REGOFFSET | ADC_INJ_RANK_3_JSQR_BITOFFSET_POS) /*!< ADC group inj. sequencer rank 3 */
#define LL_ADC_INJ_RANK_4 \
    (ADC_JDR4_REGOFFSET | ADC_INJ_RANK_4_JSQR_BITOFFSET_POS) /*!< ADC group inj. sequencer rank 4 */
/**
 * @}
 */
...
#define LL_ADC_AWD_ALL_CHANNELS_REG_INJ                                                                  \
    (ADC_AWD_CR23_CHANNEL_MASK | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1EN) /*!< ADC analog watchdog monitoring \
                           of all channels, converted by either group regular or injected */
#define LL_ADC_AWD_CHANNEL_0_REG                                                                             \
    ((LL_ADC_CHANNEL_0 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_AWD1EN | ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog \
                                          monitoring of ADC channel ADCx_IN0, converted by group regular only */
#define LL_ADC_AWD_CHANNEL_0_INJ                                                                              \
    ((LL_ADC_CHANNEL_0 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog \
                                           monitoring of ADC channel ADCx_IN0, converted by group injected only */
...
#define LL_ADC_AWD_CHANNEL_1_REG                                                                             \
    ((LL_ADC_CHANNEL_1 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_AWD1EN | ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog \
                                          monitoring of ADC channel ADCx_IN1, converted by group regular only */
#define LL_ADC_AWD_CHANNEL_1_INJ                                                                              \
    ((LL_ADC_CHANNEL_1 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog \
                                           monitoring of ADC channel ADCx_IN1, converted by group injected only */
...
#define LL_ADC_AWD_CHANNEL_2_REG                                                                             \
    ((LL_ADC_CHANNEL_2 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_AWD1EN | ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog \
                                          monitoring of ADC channel ADCx_IN2, converted by group regular only */
#define LL_ADC_AWD_CHANNEL_2_INJ                                                                              \
    ((LL_ADC_CHANNEL_2 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog \
                                           monitoring of ADC channel ADCx_IN2, converted by group injected only */
...
#define LL_ADC_AWD_CHANNEL_3_REG                                                                             \
    ((LL_ADC_CHANNEL_3 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_AWD1EN | ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog \
                                          monitoring of ADC channel ADCx_IN3, converted by group regular only */
#define LL_ADC_AWD_CHANNEL_3_INJ                                                                              \
    ((LL_ADC_CHANNEL_3 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog \
                                           monitoring of ADC channel ADCx_IN3, converted by group injected only */
...
#define LL_ADC_AWD_CHANNEL_4_REG                                                                             \
    ((LL_ADC_CHANNEL_4 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_AWD1EN | ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog \
                                          monitoring of ADC channel ADCx_IN4, converted by group regular only */
#define LL_ADC_AWD_CHANNEL_4_INJ                                                                              \
    ((LL_ADC_CHANNEL_4 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog \
                                           monitoring of ADC channel ADCx_IN4, converted by group injected only */
...
#define LL_ADC_AWD_CHANNEL_5_REG                                                                             \
    ((LL_ADC_CHANNEL_5 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_AWD1EN | ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog \
                                          monitoring of ADC channel ADCx_IN5, converted by group regular only */
#define LL_ADC_AWD_CHANNEL_5_INJ                                                                              \
    ((LL_ADC_CHANNEL_5 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog \
                                           monitoring of ADC channel ADCx_IN5, converted by group injected only */
...
#define LL_ADC_AWD_CHANNEL_6_REG                                                                             \
    ((LL_ADC_CHANNEL_6 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_AWD1EN | ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog \
                                          monitoring of ADC channel ADCx_IN6, converted by group regular only */
#define LL_ADC_AWD_CHANNEL_6_INJ                                                                              \
    ((LL_ADC_CHANNEL_6 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog \
                                           monitoring of ADC channel ADCx_IN6, converted by group injected only */
...
#define LL_ADC_AWD_CHANNEL_7_REG                                                                             \
    ((LL_ADC_CHANNEL_7 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_AWD1EN | ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog \
                                          monitoring of ADC channel ADCx_IN7, converted by group regular only */
#define LL_ADC_AWD_CHANNEL_7_INJ                                                                              \
    ((LL_ADC_CHANNEL_7 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog \
                                           monitoring of ADC channel ADCx_IN7, converted by group injected only */
...
#define LL_ADC_AWD_CHANNEL_8_REG                                                                             \
    ((LL_ADC_CHANNEL_8 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_AWD1EN | ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog \
                                          monitoring of ADC channel ADCx_IN8, converted by group regular only */
#define LL_ADC_AWD_CHANNEL_8_INJ                                                                              \
    ((LL_ADC_CHANNEL_8 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog \
                                           monitoring of ADC channel ADCx_IN8, converted by group injected only */
...
#define LL_ADC_AWD_CHANNEL_9_REG                                                                             \
    ((LL_ADC_CHANNEL_9 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_AWD1EN | ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog \
                                          monitoring of ADC channel ADCx_IN9, converted by group regular only */
#define LL_ADC_AWD_CHANNEL_9_INJ                                                                              \
    ((LL_ADC_CHANNEL_9 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog \
                                           monitoring of ADC channel ADCx_IN9, converted by group injected only */
...
#define LL_ADC_AWD_CHANNEL_10_REG                                                                             \
    ((LL_ADC_CHANNEL_10 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_AWD1EN | ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog \
                                           monitoring of ADC channel ADCx_IN10, converted by group regular only */
#define LL_ADC_AWD_CHANNEL_10_INJ                                                                              \
    ((LL_ADC_CHANNEL_10 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog \
                                            monitoring of ADC channel ADCx_IN10, converted by group injected only */
...
#define LL_ADC_AWD_CHANNEL_11_REG                                                                             \
    ((LL_ADC_CHANNEL_11 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_AWD1EN | ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog \
                                           monitoring of ADC channel ADCx_IN11, converted by group regular only */
#define LL_ADC_AWD_CHANNEL_11_INJ                                                                              \
    ((LL_ADC_CHANNEL_11 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog \
                                            monitoring of ADC channel ADCx_IN11, converted by group injected only */
...
#define LL_ADC_AWD_CHANNEL_12_REG                                                                             \
    ((LL_ADC_CHANNEL_12 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_AWD1EN | ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog \
                                           monitoring of ADC channel ADCx_IN12, converted by group regular only */
#define LL_ADC_AWD_CHANNEL_12_INJ                                                                              \
    ((LL_ADC_CHANNEL_12 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog \
                                            monitoring of ADC channel ADCx_IN12, converted by group injected only */
...
#define LL_ADC_AWD_CHANNEL_13_REG                                                                             \
    ((LL_ADC_CHANNEL_13 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_AWD1EN | ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog \
                                           monitoring of ADC channel ADCx_IN13, converted by group regular only */
#define LL_ADC_AWD_CHANNEL_13_INJ                                                                              \
    ((LL_ADC_CHANNEL_13 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog \
                                            monitoring of ADC channel ADCx_IN13, converted by group injected only */
...
#define LL_ADC_AWD_CHANNEL_14_REG                                                                             \
    ((LL_ADC_CHANNEL_14 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_AWD1EN | ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog \
                                           monitoring of ADC channel ADCx_IN14, converted by group regular only */
#define LL_ADC_AWD_CHANNEL_14_INJ                                                                              \
    ((LL_ADC_CHANNEL_14 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog \
                                            monitoring of ADC channel ADCx_IN14, converted by group only */
...
#define LL_ADC_AWD_CHANNEL_15_INJ                                                                              \
    ((LL_ADC_CHANNEL_15 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog \
                                            monitoring of ADC channel ADCx_IN15, converted by group injected only */
#define LL_ADC_AWD_CHANNEL_15_REG_INJ                                                                            \
    ((LL_ADC_CHANNEL_15 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1EN | ADC_CFGR_AWD1SGL) /*!< ADC \
                                                              analog watchdog monitoring of ADC channel ADCx_IN15,                                                                                       \
                                                              converted by either group regular or injected */
#define LL_ADC_AWD_CHANNEL_16_REG                                                                             \
    ((LL_ADC_CHANNEL_16 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_AWD1EN | ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog \
                                           monitoring of ADC channel ADCx_IN16, converted by group regular only */
#define LL_ADC_AWD_CHANNEL_16_INJ                                                                              \
    ((LL_ADC_CHANNEL_16 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog \
                                            monitoring of ADC channel ADCx_IN16, converted by group injected only */
...
#define LL_ADC_AWD_CHANNEL_17_REG                                                                             \
    ((LL_ADC_CHANNEL_17 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_AWD1EN | ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog \
                                           monitoring of ADC channel ADCx_IN17, converted by group regular only */
#define LL_ADC_AWD_CHANNEL_17_INJ                                                                              \
    ((LL_ADC_CHANNEL_17 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog \
                                            monitoring of ADC channel ADCx_IN17, converted by group injected only */
...
#define LL_ADC_AWD_CHANNEL_18_REG                                                                             \
    ((LL_ADC_CHANNEL_18 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_AWD1EN | ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog \
                                           monitoring of ADC channel ADCx_IN18, converted by group regular only */
#define LL_ADC_AWD_CHANNEL_18_INJ                                                                              \
    ((LL_ADC_CHANNEL_18 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog \
                                            monitoring of ADC channel ADCx_IN18, converted by group injected only */
#define LL_ADC_AWD_CHANNEL_18_REG_INJ                                                                            \
    ((LL_ADC_CHANNEL_18 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1EN | ADC_CFGR_AWD1SGL) /*!< ADC \
                                                              analog watchdog monitoring of ADC channel ADCx_IN18,                                                                                       \
                                                              converted by either group regular or injected */
#define LL_ADC_AWD_CH_VREFINT_REG                                                                                  \
    ((LL_ADC_CHANNEL_VREFINT & ADC_CHANNEL_ID_MASK) | ADC_CFGR_AWD1EN | ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog \
...
#define LL_ADC_AWD_CH_VREFINT_INJ                                                                                   \
    ((LL_ADC_CHANNEL_VREFINT & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog \
                                                 monitoring of ADC internal channel connected to VrefInt: Internal                                                             \
...
#define LL_ADC_AWD_CH_TEMPSENSOR_REG                                                                                  \
    ((LL_ADC_CHANNEL_TEMPSENSOR & ADC_CHANNEL_ID_MASK) | ADC_CFGR_AWD1EN | ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog \
                                                   monitoring of ADC internal channel connected to internal                                                                        \
                                                   temperature sensor, converted by group regular only */
#define LL_ADC_AWD_CH_TEMPSENSOR_INJ                                                                                   \
    ((LL_ADC_CHANNEL_TEMPSENSOR & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog \
                                                    monitoring of ADC internal channel connected to internal                                                                         \
                                                    temperature sensor, converted by group injected only */
...
#define LL_ADC_AWD_CH_DAC1CH1_REG                                                                                  \
    ((LL_ADC_CHANNEL_DAC1CH1 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_AWD1EN | ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog \
                                                monitoring of ADC internal channel connected to DAC1 channel 1,                                                              \
                                                channel specific to ADC1, converted by group regular only */
#define LL_ADC_AWD_CH_DAC1CH1_INJ                                                                                   \
    ((LL_ADC_CHANNEL_DAC1CH1 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog \
                                                 monitoring of ADC internal channel connected to DAC1 channel 1,                                                               \
...
#define LL_ADC_AWD_CH_DAC1CH2_REG                                                                                  \
    ((LL_ADC_CHANNEL_DAC1CH2 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_AWD1EN | ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog \
                                                monitoring of ADC internal channel connected to DAC1 channel 2,                                                              \
                                                channel specific to ADC1, converted by group regular only */
#define LL_ADC_AWD_CH_DAC1CH2_INJ                                                                                   \
    ((LL_ADC_CHANNEL_DAC1CH2 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog \
                                                 monitoring of ADC internal channel connected to DAC1 channel 2,                                                               \
                                                 channel specific to ADC1, converted by group injected only */
...
#define LL_ADC_MULTI_DUAL_REG_INTERL                                                              \
    (ADC_CCR_DUAL_2 | ADC_CCR_DUAL_1 | ADC_CCR_DUAL_0) /*!< ADC dual mode enabled: Combined group \
                   regular interleaved */
...
#define LL_ADC_MULTI_TWOSMP_DELAY_8CYCLES                                                      \
    (ADC_CCR_DELAY_2 | ADC_CCR_DELAY_1 | ADC_CCR_DELAY_0) /*!< ADC multimode delay between two \
...
#define LL_ADC_MULTI_TWOSMP_DELAY_12CYCLES                                                     \
    (ADC_CCR_DELAY_3 | ADC_CCR_DELAY_1 | ADC_CCR_DELAY_0) /*!< ADC multimode delay between two \
    ...
    if (analog_wd_monit_channels != 0UL) {
        if (AWDy == LL_ADC_AWD1) {
            ...
            if ((analog_wd_monit_channels & ADC_AWD_CR23_CHANNEL_MASK) == ADC_AWD_CR23_CHANNEL_MASK) {
                ...
                /* AWD monitoring a group of channels */
                analog_wd_monit_channels =
                    (analog_wd_monit_channels | (ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1EN | ADC_CFGR_AWD1SGL) |
