...
#define IS_LCD_DIVIDER(__DIVIDER__)                                                                                 \
    (((__DIVIDER__) == LCD_DIVIDER_16) || ((__DIVIDER__) == LCD_DIVIDER_17) || ((__DIVIDER__) == LCD_DIVIDER_18) || \
     ((__DIVIDER__) == LCD_DIVIDER_19) || ((__DIVIDER__) == LCD_DIVIDER_20) || ((__DIVIDER__) == LCD_DIVIDER_21) || \
     ((__DIVIDER__) == LCD_DIVIDER_22) || ((__DIVIDER__) == LCD_DIVIDER_23) || ((__DIVIDER__) == LCD_DIVIDER_24) || \
     ((__DIVIDER__) == LCD_DIVIDER_25) || ((__DIVIDER__) == LCD_DIVIDER_26) || ((__DIVIDER__) == LCD_DIVIDER_27) || \
     ((__DIVIDER__) == LCD_DIVIDER_28) || ((__DIVIDER__) == LCD_DIVIDER_29) || ((__DIVIDER__) == LCD_DIVIDER_30) || \
