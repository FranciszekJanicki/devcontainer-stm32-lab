...
#define LL_RCC_SAI1_CLKSOURCE_PIN  \
    ((RCC_CCIPR2_SAI1SEL << 16U) | \
     (RCC_CCIPR2_SAI1SEL_1 | RCC_CCIPR2_SAI1SEL_0)) /*!< External input clock used as SAI1 clock source */
...
#define LL_RCC_SAI2_CLKSOURCE_PIN  \
    ((RCC_CCIPR2_SAI2SEL << 16U) | \
     (RCC_CCIPR2_SAI2SEL_1 | RCC_CCIPR2_SAI2SEL_0)) /*!< External input clock used as SAI2 clock source */
...
LL_RCC_PLLSAI2_ConfigDomain_LTDC(uint32_t Source, uint32_t PLLM, uint32_t PLLN, uint32_t PLLR, uint32_t PLLDIVR)
{
    MODIFY_REG(RCC->PLLCFGR, RCC_PLLCFGR_PLLSRC, Source);
    MODIFY_REG(RCC->PLLSAI2CFGR,
