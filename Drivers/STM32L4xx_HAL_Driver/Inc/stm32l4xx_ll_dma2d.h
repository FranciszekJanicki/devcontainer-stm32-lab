...
typedef struct {
    ...
    uint32_t
        NbrOfPixelsPerLines; /*!< Specifies the number of pixels per lines of the area to be transferred.
...
#define LL_DMA2D_MODE_M2M_BLEND_FIXED_COLOR_FG \
    DMA2D_CR_MODE_2 /*!< DMA2D memory to memory with blending transfer mode and fixed color foreground */
#define LL_DMA2D_MODE_M2M_BLEND_FIXED_COLOR_BG \
    (DMA2D_CR_MODE_0 |                         \
     DMA2D_CR_MODE_2) /*!< DMA2D memory to memory with blending transfer mode and fixed color background */
