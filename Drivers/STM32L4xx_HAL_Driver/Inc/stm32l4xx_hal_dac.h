...
#define DAC_TRIGGER_NONE                                                   \
    0x00000000U /*!< Conversion is automatic once the DAC_DHRxxxx register \
                     has been loaded, and not by external trigger */
#define DAC_TRIGGER_T2_TRGO \
    (DAC_CR_TSEL1_2 | DAC_CR_TEN1)        /*!< TIM2 TRGO selected as external conversion trigger for DAC channel */
...
#define DAC_TRIGGER_T7_TRGO \
    (DAC_CR_TSEL1_1 | DAC_CR_TEN1) /*!< TIM7 TRGO selected as external conversion trigger for DAC channel */
...
#define DAC_TRIGGER_T8_TRGO \
    (DAC_CR_TSEL1_0 | DAC_CR_TEN1) /*!< TIM8 TRGO selected as external conversion trigger for DAC channel */
#define DAC_TRIGGER_EXT_IT9            \
    (DAC_CR_TSEL1_2 | DAC_CR_TSEL1_1 | \
     DAC_CR_TEN1) /*!< EXTI Line9 event selected as external conversion trigger for DAC channel */
#define DAC_TRIGGER_SOFTWARE (DAC_CR_TSEL1 | DAC_CR_TEN1) /*!< Conversion started by software trigger for DAC channel \
    ...
    defined(STM32L4R9xx) || defined(STM32L4S5xx) || defined(STM32L4S7xx) || defined(STM32L4S9xx)
#define DAC_TRIGGER_NONE                                                                                        \
    0x00000000U /*!< conversion is automatic once the DAC_DHRxxxx register has been loaded, and not by external \
                   trigger */
#define DAC_TRIGGER_SOFTWARE (DAC_CR_TEN1) /*!< conversion started by software trigger for DAC channel */
#define DAC_TRIGGER_T1_TRGO \
    (DAC_CR_TSEL1_0 | DAC_CR_TEN1) /*!< TIM1 TRGO selected as external conversion trigger for DAC channel. */
#define DAC_TRIGGER_T2_TRGO \
    (DAC_CR_TSEL1_1 | DAC_CR_TEN1) /*!< TIM2 TRGO selected as external conversion trigger for DAC channel */
#define DAC_TRIGGER_T4_TRGO            \
    (DAC_CR_TSEL1_1 | DAC_CR_TSEL1_0 | \
     DAC_CR_TEN1) /*!< TIM4 TRGO selected as external conversion trigger for DAC channel */
#define DAC_TRIGGER_T5_TRGO \
    (DAC_CR_TSEL1_2 | DAC_CR_TEN1) /*!< TIM5 TRGO selected as external conversion trigger for DAC channel */
#define DAC_TRIGGER_T6_TRGO            \
    (DAC_CR_TSEL1_2 | DAC_CR_TSEL1_0 | \
     DAC_CR_TEN1) /*!< TIM6 TRGO selected as external conversion trigger for DAC channel */
#define DAC_TRIGGER_T7_TRGO            \
    (DAC_CR_TSEL1_2 | DAC_CR_TSEL1_1 | \
...
#define DAC_TRIGGER_T15_TRGO \
    (DAC_CR_TSEL1_3 | DAC_CR_TEN1) /*!< TIM15 TRGO selected as external conversion trigger for DAC channel */
#define DAC_TRIGGER_LPTIM1_OUT                          \
...
#define DAC_TRIGGER_LPTIM2_OUT         \
    (DAC_CR_TSEL1_3 | DAC_CR_TSEL1_2 | \
     DAC_CR_TEN1) /*!< LPTIM2 OUT TRGO selected as external conversion trigger for DAC channel */
#define DAC_TRIGGER_EXT_IT9                             \
