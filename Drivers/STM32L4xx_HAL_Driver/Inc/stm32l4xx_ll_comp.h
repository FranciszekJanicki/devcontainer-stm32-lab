...
#define LL_COMP_WINDOWMODE_COMP1_INPUT_PLUS_COMMON                                                               \
    (COMP_CSR_WINMODE) /*!< Window mode enable: Comparators instances pair COMP1 and COMP2 have their input plus \
                          connected together. The common input is COMP1 input plus (COMP2 input plus is no more  \
                          accessible). */
#endif                 /* COMP2 */
/**
 * @}
...
#define LL_COMP_OUTPUTPOL_NONINVERTED                                                                                 \
    (0x00000000UL) /*!< COMP output polarity is not inverted: comparator output is high when the plus (non-inverting) \
                      input is at a higher voltage than the minus (inverting) input */
#define LL_COMP_OUTPUTPOL_INVERTED                                                                                    \
    (COMP_CSR_POLARITY) /*!< COMP output polarity is inverted: comparator output is low when the plus (non-inverting) \
                           input is at a lower voltage than the minus (inverting) input */
/**
 * @}
 */
...
#define LL_COMP_OUTPUT_LEVEL_LOW \
    (0x00000000UL) /*!< Comparator output level low (if the polarity is not inverted, otherwise to be complemented) */
#define LL_COMP_OUTPUT_LEVEL_HIGH                                                                                    \
    (0x00000001UL) /*!< Comparator output level high (if the polarity is not inverted, otherwise to be complemented) \
                    */
/**
 * @}
 */
