...
#define IS_TSC_CTPH(__VALUE__)                                                                                         \
    (((__VALUE__) == TSC_CTPH_1CYCLE) || ((__VALUE__) == TSC_CTPH_2CYCLES) || ((__VALUE__) == TSC_CTPH_3CYCLES) ||     \
     ((__VALUE__) == TSC_CTPH_4CYCLES) || ((__VALUE__) == TSC_CTPH_5CYCLES) || ((__VALUE__) == TSC_CTPH_6CYCLES) ||    \
     ((__VALUE__) == TSC_CTPH_7CYCLES) || ((__VALUE__) == TSC_CTPH_8CYCLES) || ((__VALUE__) == TSC_CTPH_9CYCLES) ||    \
     ((__VALUE__) == TSC_CTPH_10CYCLES) || ((__VALUE__) == TSC_CTPH_11CYCLES) || ((__VALUE__) == TSC_CTPH_12CYCLES) || \
     ((__VALUE__) == TSC_CTPH_13CYCLES) || ((__VALUE__) == TSC_CTPH_14CYCLES) || ((__VALUE__) == TSC_CTPH_15CYCLES) || \
     ((__VALUE__) == TSC_CTPH_16CYCLES))

#define IS_TSC_CTPL(__VALUE__)                                                                                         \
    (((__VALUE__) == TSC_CTPL_1CYCLE) || ((__VALUE__) == TSC_CTPL_2CYCLES) || ((__VALUE__) == TSC_CTPL_3CYCLES) ||     \
     ((__VALUE__) == TSC_CTPL_4CYCLES) || ((__VALUE__) == TSC_CTPL_5CYCLES) || ((__VALUE__) == TSC_CTPL_6CYCLES) ||    \
     ((__VALUE__) == TSC_CTPL_7CYCLES) || ((__VALUE__) == TSC_CTPL_8CYCLES) || ((__VALUE__) == TSC_CTPL_9CYCLES) ||    \
     ((__VALUE__) == TSC_CTPL_10CYCLES) || ((__VALUE__) == TSC_CTPL_11CYCLES) || ((__VALUE__) == TSC_CTPL_12CYCLES) || \
     ((__VALUE__) == TSC_CTPL_13CYCLES) || ((__VALUE__) == TSC_CTPL_14CYCLES) || ((__VALUE__) == TSC_CTPL_15CYCLES) || \
...
#define IS_TSC_PG_PRESC(__VALUE__)                                                                                     \
    (((__VALUE__) == TSC_PG_PRESC_DIV1) || ((__VALUE__) == TSC_PG_PRESC_DIV2) || ((__VALUE__) == TSC_PG_PRESC_DIV4) || \
     ((__VALUE__) == TSC_PG_PRESC_DIV8) || ((__VALUE__) == TSC_PG_PRESC_DIV16) ||                                      \
     ((__VALUE__) == TSC_PG_PRESC_DIV32) || ((__VALUE__) == TSC_PG_PRESC_DIV64) ||                                     \
     ((__VALUE__) == TSC_PG_PRESC_DIV128))

#define IS_TSC_PG_PRESC_VS_CTPL(__PGPSC__, __CTPL__)                                                                 \
    ((((__PGPSC__) == TSC_PG_PRESC_DIV1) && (((__CTPL__) == TSC_CTPL_1CYCLE) || ((__CTPL__) > TSC_CTPL_2CYCLES))) || \
...
#define IS_TSC_MCV(__VALUE__)                                                                           \
    (((__VALUE__) == TSC_MCV_255) || ((__VALUE__) == TSC_MCV_511) || ((__VALUE__) == TSC_MCV_1023) ||   \
     ((__VALUE__) == TSC_MCV_2047) || ((__VALUE__) == TSC_MCV_4095) || ((__VALUE__) == TSC_MCV_8191) || \
...
#define IS_TSC_SYNC_POL(__VALUE__) \
    (((__VALUE__) == TSC_SYNC_POLARITY_FALLING) || ((__VALUE__) == TSC_SYNC_POLARITY_RISING))
...
#define IS_TSC_GROUP_INDEX(__VALUE__) \
    (((__VALUE__) == 0UL) || (((__VALUE__) > 0UL) && ((__VALUE__) < (uint32_t)TSC_NB_OF_GROUPS)))

#define IS_TSC_GROUP(__VALUE__)                                                                                   \
    ((((__VALUE__) & TSC_GROUPX_NOT_SUPPORTED) != TSC_GROUPX_NOT_SUPPORTED) &&                                    \
     (((__VALUE__) == 0UL) || (((__VALUE__) & TSC_GROUP1_IO1) == TSC_GROUP1_IO1) ||                               \
      (((__VALUE__) & TSC_GROUP1_IO2) == TSC_GROUP1_IO2) || (((__VALUE__) & TSC_GROUP1_IO3) == TSC_GROUP1_IO3) || \
      (((__VALUE__) & TSC_GROUP1_IO4) == TSC_GROUP1_IO4) || (((__VALUE__) & TSC_GROUP2_IO1) == TSC_GROUP2_IO1) || \
      (((__VALUE__) & TSC_GROUP2_IO2) == TSC_GROUP2_IO2) || (((__VALUE__) & TSC_GROUP2_IO3) == TSC_GROUP2_IO3) || \
      (((__VALUE__) & TSC_GROUP2_IO4) == TSC_GROUP2_IO4) || (((__VALUE__) & TSC_GROUP3_IO1) == TSC_GROUP3_IO1) || \
      (((__VALUE__) & TSC_GROUP3_IO2) == TSC_GROUP3_IO2) || (((__VALUE__) & TSC_GROUP3_IO3) == TSC_GROUP3_IO3) || \
      (((__VALUE__) & TSC_GROUP3_IO4) == TSC_GROUP3_IO4) || (((__VALUE__) & TSC_GROUP4_IO1) == TSC_GROUP4_IO1) || \
      (((__VALUE__) & TSC_GROUP4_IO2) == TSC_GROUP4_IO2) || (((__VALUE__) & TSC_GROUP4_IO3) == TSC_GROUP4_IO3) || \
      (((__VALUE__) & TSC_GROUP4_IO4) == TSC_GROUP4_IO4) || (((__VALUE__) & TSC_GROUP5_IO1) == TSC_GROUP5_IO1) || \
      (((__VALUE__) & TSC_GROUP5_IO2) == TSC_GROUP5_IO2) || (((__VALUE__) & TSC_GROUP5_IO3) == TSC_GROUP5_IO3) || \
      (((__VALUE__) & TSC_GROUP5_IO4) == TSC_GROUP5_IO4) || (((__VALUE__) & TSC_GROUP6_IO1) == TSC_GROUP6_IO1) || \
      (((__VALUE__) & TSC_GROUP6_IO2) == TSC_GROUP6_IO2) || (((__VALUE__) & TSC_GROUP6_IO3) == TSC_GROUP6_IO3) || \
      (((__VALUE__) & TSC_GROUP6_IO4) == TSC_GROUP6_IO4) || (((__VALUE__) & TSC_GROUP7_IO1) == TSC_GROUP7_IO1) || \
      (((__VALUE__) & TSC_GROUP7_IO2) == TSC_GROUP7_IO2) || (((__VALUE__) & TSC_GROUP7_IO3) == TSC_GROUP7_IO3) || \
      (((__VALUE__) & TSC_GROUP7_IO4) == TSC_GROUP7_IO4) || (((__VALUE__) & TSC_GROUP8_IO1) == TSC_GROUP8_IO1) || \
      (((__VALUE__) & TSC_GROUP8_IO2) == TSC_GROUP8_IO2) || (((__VALUE__) & TSC_GROUP8_IO3) == TSC_GROUP8_IO3) || \
