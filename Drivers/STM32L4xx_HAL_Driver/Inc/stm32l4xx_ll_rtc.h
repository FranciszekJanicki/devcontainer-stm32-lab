...
typedef struct {
    uint32_t
        TimeFormat; /*!< Specifies the RTC AM/PM Time.
    ...
    uint8_t Hours; /*!< Specifies the RTC Time Hours.
                      ...
                      LL_RTC_TIME_FORMAT_PM is selected. This parameter must be a number between Min_Data = 0 and
                      Max_Data = 23 if the @ref LL_RTC_TIME_FORMAT_AM_OR_24 is selected.

                        This feature can be modified afterwards using unitary function @ref LL_RTC_TIME_SetHour(). */

    uint8_t
        Minutes; /*!< Specifies the RTC Time Minutes.
                      This parameter must be a number between Min_Data = 0 and Max_Data = 59

                      This feature can be modified afterwards using unitary function @ref LL_RTC_TIME_SetMinute(). */

    uint8_t
        Seconds; /*!< Specifies the RTC Time Seconds.
                      This parameter must be a number between Min_Data = 0 and Max_Data = 59
...
typedef struct {
    uint8_t
        WeekDay; /*!< Specifies the RTC Date WeekDay.
...
typedef struct {
    ...
    uint32_t AlarmMask; /*!< Specifies the RTC Alarm Masks.
                           ...
                           for ALARM A or @ref LL_RTC_ALMB_SetMask() for ALARM B
                        */

    uint32_t AlarmDateWeekDaySel; /*!< Specifies the RTC Alarm is on day or WeekDay.
                                       This parameter can be a value of @ref RTC_LL_EC_ALMA_WEEKDAY_SELECTION for ALARM
                                     A or @ref RTC_LL_EC_ALMB_WEEKDAY_SELECTION for ALARM B

                                       This feature can be modified afterwards using unitary function @ref
                                     LL_RTC_ALMA_EnableWeekday() or @ref LL_RTC_ALMA_DisableWeekday() for ALARM A or
                                     @ref LL_RTC_ALMB_EnableWeekday() or @ref LL_RTC_ALMB_DisableWeekday() for ALARM B
                                  */

    uint8_t AlarmDateWeekDay; /*!< Specifies the RTC Alarm Day/WeekDay.
                                   If AlarmDateWeekDaySel set to day, this parameter  must be a number between Min_Data
                                 = 1 and Max_Data = 31.

                                   This feature can be modified afterwards using unitary function @ref
                                 LL_RTC_ALMA_SetDay() for ALARM A or @ref LL_RTC_ALMB_SetDay() for ALARM B.

                                   If AlarmDateWeekDaySel set to Weekday, this parameter can be a value of @ref
                                 RTC_LL_EC_WEEKDAY.
...
/** @defgroup RTC_ALMA_SUBSECONDBIN_AUTOCLR  RTCEx_AlarmA_Sub_Seconds_binary_Clear_Definitions RTC Alarm Sub Seconds
 * with binary mode auto clear Definitions
 * @{
 */
#define LL_RTC_ALMA_SUBSECONDBIN_AUTOCLR_NO \
    0UL /*!<  The synchronous binary counter (SS[31:0] in RTC_SSR) is free-running. */
#define LL_RTC_ALMA_SUBSECONDBIN_AUTOCLR_YES                                                                     \
    RTC_ALRMASSR_SSCLR /*!<  The synchronous binary counter (SS[31:0] in RTC_SSR) is running from 0xFFFF FFFF to \
...
#if defined(STM32L4P5xx) || defined(STM32L4Q5xx)
/** @defgroup RTC_ALMB_SUBSECONDBIN_AUTOCLR  RTCEx_AlarmB_Sub_Seconds_binary_Clear_Definitions RTC Alarm Sub Seconds
 * with binary mode auto clear Definitions
 * @{
 */
#define LL_RTC_ALMB_SUBSECONDBIN_AUTOCLR_NO \
    0UL /*!<  The synchronous binary counter (SS[31:0] in RTC_SSR) is free-running. */
#define LL_RTC_ALMB_SUBSECONDBIN_AUTOCLR_YES                                                                     \
    RTC_ALRMBSSR_SSCLR /*!<  The synchronous binary counter (SS[31:0] in RTC_SSR) is running from 0xFFFF FFFF to \
                             RTC_ALRMABINR -> SS[31:0] value and is automatically reloaded with 0xFFFF FFFF      \
                             when reaching RTC_ALRMABINR -> SS[31:0]. */
/**
 * @}
...
#define LL_RTC_TAMPER_MASK_TAMPER1                                                                              \
    TAMP_CR2_TAMP1MSK /*!< Tamper 1 event generates a trigger event. TAMP1F is masked and internally cleared by \
                         hardware.The backup registers are not erased */
#define LL_RTC_TAMPER_MASK_TAMPER2                                                                              \
    TAMP_CR2_TAMP2MSK /*!< Tamper 2 event generates a trigger event. TAMP2F is masked and internally cleared by \
                         hardware. The backup registers are not erased. */
#if defined(STM32L4P5xx) || defined(STM32L4Q5xx)
#define LL_RTC_TAMPER_MASK_TAMPER3                                                                              \
    TAMP_CR2_TAMP3MSK /*!< Tamper 3 event generates a trigger event. TAMP3F is masked and internally cleared by \
                         hardware. The backup registers are not erased. */
#endif
/**
 * @}
...
#define LL_RTC_TAMPER_DURATION_2RTCCLK \
    TAMP_FLTCR_TAMPPRCH_0 /*!< Tamper pins are pre-charged before sampling during 2 RTCCLK cycles */
#define LL_RTC_TAMPER_DURATION_4RTCCLK \
    TAMP_FLTCR_TAMPPRCH_1 /*!< Tamper pins are pre-charged before sampling during 4 RTCCLK cycles */
#define LL_RTC_TAMPER_DURATION_8RTCCLK \
    TAMP_FLTCR_TAMPPRCH /*!< Tamper pins are pre-charged before sampling during 8 RTCCLK cycles */
/**
 * @}
 */
...
#define LL_RTC_TAMPER_FILTER_2SAMPLE \
    TAMP_FLTCR_TAMPFLT_0 /*!< Tamper is activated after 2 consecutive samples at the active level */
#define LL_RTC_TAMPER_FILTER_4SAMPLE \
    TAMP_FLTCR_TAMPFLT_1 /*!< Tamper is activated after 4 consecutive samples at the active level */
#define LL_RTC_TAMPER_FILTER_8SAMPLE \
    TAMP_FLTCR_TAMPFLT /*!< Tamper is activated after 8 consecutive samples at the active level. */
/**
 * @}
 */
...
#define LL_RTC_TAMPER_SAMPLFREQDIV_16384 \
    TAMP_FLTCR_TAMPFREQ_0 /*!< Each of the tamper inputs are sampled with a frequency =  RTCCLK / 16384 */
#define LL_RTC_TAMPER_SAMPLFREQDIV_8192 \
    TAMP_FLTCR_TAMPFREQ_1 /*!< Each of the tamper inputs are sampled with a frequency =  RTCCLK / 8192 */
#define LL_RTC_TAMPER_SAMPLFREQDIV_4096 \
    (TAMP_FLTCR_TAMPFREQ_1 |            \
     TAMP_FLTCR_TAMPFREQ_0) /*!< Each of the tamper inputs are sampled with a frequency =  RTCCLK / 4096 */
#define LL_RTC_TAMPER_SAMPLFREQDIV_2048 \
    TAMP_FLTCR_TAMPFREQ_2 /*!< Each of the tamper inputs are sampled with a frequency =  RTCCLK / 2048 */
#define LL_RTC_TAMPER_SAMPLFREQDIV_1024 \
    (TAMP_FLTCR_TAMPFREQ_2 |            \
     TAMP_FLTCR_TAMPFREQ_0) /*!< Each of the tamper inputs are sampled with a frequency =  RTCCLK / 1024 */
#define LL_RTC_TAMPER_SAMPLFREQDIV_512 \
    (TAMP_FLTCR_TAMPFREQ_2 |           \
     TAMP_FLTCR_TAMPFREQ_1) /*!< Each of the tamper inputs are sampled with a frequency =  RTCCLK / 512 */
#define LL_RTC_TAMPER_SAMPLFREQDIV_256 \
    TAMP_FLTCR_TAMPFREQ /*!< Each of the tamper inputs are sampled with a frequency =  RTCCLK / 256 */
/**
 * @}
 */
...
#define LL_RTC_TAMPER_ACTIVELEVEL_TAMP1                                                                                \
    TAMP_CR2_TAMP1TRG /*!< Tamper 1 input falling edge (if TAMPFLT = 00) or staying high (if TAMPFLT != 00) triggers a \
                         tamper detection event */
#define LL_RTC_TAMPER_ACTIVELEVEL_TAMP2                                                                                \
    TAMP_CR2_TAMP2TRG /*!< Tamper 2 input falling edge (if TAMPFLT = 00) or staying high (if TAMPFLT != 00) triggers a \
                         tamper detection event */
#if defined(STM32L4P5xx) || defined(STM32L4Q5xx)
#define LL_RTC_TAMPER_ACTIVELEVEL_TAMP3                                                                                \
    TAMP_CR2_TAMP3TRG /*!< Tamper 3 input falling edge (if TAMPFLT = 00) or staying high (if TAMPFLT != 00) triggers a \
                         tamper detection event */
#endif
/**
 * @}
...
#if defined(RTC_TAMPER1_SUPPORT)
#define LL_RTC_TAMPER_MASK_TAMPER1                                                                               \
    RTC_TAMPCR_TAMP1MF /*!< Tamper 1 event generates a trigger event. TAMP1F is masked and internally cleared by \
                          hardware.The backup registers are not erased */
#endif                 /* RTC_TAMPER1_SUPPORT */
#if defined(RTC_TAMPER2_SUPPORT)
#define LL_RTC_TAMPER_MASK_TAMPER2                                                                               \
    RTC_TAMPCR_TAMP2MF /*!< Tamper 2 event generates a trigger event. TAMP2F is masked and internally cleared by \
                          hardware. The backup registers are not erased. */
#endif                 /* RTC_TAMPER2_SUPPORT */
#if defined(RTC_TAMPER3_SUPPORT)
#define LL_RTC_TAMPER_MASK_TAMPER3                                                                               \
    RTC_TAMPCR_TAMP3MF /*!< Tamper 3 event generates a trigger event. TAMP3F is masked and internally cleared by \
                          hardware. The backup registers are not erased */
#endif                 /* RTC_TAMPER3_SUPPORT */
/**
 * @}
...
#define LL_RTC_TAMPER_DURATION_1RTCCLK \
    0x00000000U /*!< Tamper pins are pre-charged before sampling during 1 RTCCLK cycle  */
#define LL_RTC_TAMPER_DURATION_2RTCCLK \
    RTC_TAMPCR_TAMPPRCH_0 /*!< Tamper pins are pre-charged before sampling during 2 RTCCLK cycles */
#define LL_RTC_TAMPER_DURATION_4RTCCLK \
    RTC_TAMPCR_TAMPPRCH_1 /*!< Tamper pins are pre-charged before sampling during 4 RTCCLK cycles */
#define LL_RTC_TAMPER_DURATION_8RTCCLK \
    RTC_TAMPCR_TAMPPRCH /*!< Tamper pins are pre-charged before sampling during 8 RTCCLK cycles */
/**
 * @}
 */
...
#define LL_RTC_TAMPER_FILTER_DISABLE 0x00000000U /*!< Tamper filter is disabled */
#define LL_RTC_TAMPER_FILTER_2SAMPLE \
    RTC_TAMPCR_TAMPFLT_0 /*!< Tamper is activated after 2 consecutive samples at the active level */
#define LL_RTC_TAMPER_FILTER_4SAMPLE \
    RTC_TAMPCR_TAMPFLT_1 /*!< Tamper is activated after 4 consecutive samples at the active level */
#define LL_RTC_TAMPER_FILTER_8SAMPLE \
    RTC_TAMPCR_TAMPFLT /*!< Tamper is activated after 8 consecutive samples at the active level. */
/**
 * @}
 */
...
#define LL_RTC_TAMPER_SAMPLFREQDIV_32768 \
    0x00000000U /*!< Each of the tamper inputs are sampled with a frequency =  RTCCLK / 32768 */
#define LL_RTC_TAMPER_SAMPLFREQDIV_16384 \
    RTC_TAMPCR_TAMPFREQ_0 /*!< Each of the tamper inputs are sampled with a frequency =  RTCCLK / 16384 */
#define LL_RTC_TAMPER_SAMPLFREQDIV_8192 \
    RTC_TAMPCR_TAMPFREQ_1 /*!< Each of the tamper inputs are sampled with a frequency =  RTCCLK / 8192 */
#define LL_RTC_TAMPER_SAMPLFREQDIV_4096 \
    (RTC_TAMPCR_TAMPFREQ_1 |            \
     RTC_TAMPCR_TAMPFREQ_0) /*!< Each of the tamper inputs are sampled with a frequency =  RTCCLK / 4096 */
#define LL_RTC_TAMPER_SAMPLFREQDIV_2048 \
    RTC_TAMPCR_TAMPFREQ_2 /*!< Each of the tamper inputs are sampled with a frequency =  RTCCLK / 2048 */
#define LL_RTC_TAMPER_SAMPLFREQDIV_1024 \
    (RTC_TAMPCR_TAMPFREQ_2 |            \
     RTC_TAMPCR_TAMPFREQ_0) /*!< Each of the tamper inputs are sampled with a frequency =  RTCCLK / 1024 */
#define LL_RTC_TAMPER_SAMPLFREQDIV_512 \
    (RTC_TAMPCR_TAMPFREQ_2 |           \
     RTC_TAMPCR_TAMPFREQ_1) /*!< Each of the tamper inputs are sampled with a frequency =  RTCCLK / 512 */
#define LL_RTC_TAMPER_SAMPLFREQDIV_256 \
    RTC_TAMPCR_TAMPFREQ /*!< Each of the tamper inputs are sampled with a frequency =  RTCCLK / 256 */
/**
 * @}
 */
...
#if defined(RTC_TAMPER1_SUPPORT)
#define LL_RTC_TAMPER_ACTIVELEVEL_TAMP1                                                                        \
    RTC_TAMPCR_TAMP1TRG /*!< RTC_TAMP1 input falling edge (if TAMPFLT = 00) or staying high (if TAMPFLT != 00) \
                           triggers a tamper detection event*/
#endif                  /* RTC_TAMPER1_SUPPORT */
#if defined(RTC_TAMPER2_SUPPORT)
#define LL_RTC_TAMPER_ACTIVELEVEL_TAMP2                                                                        \
    RTC_TAMPCR_TAMP2TRG /*!< RTC_TAMP2 input falling edge (if TAMPFLT = 00) or staying high (if TAMPFLT != 00) \
                           triggers a tamper detection event*/
#endif                  /* RTC_TAMPER2_SUPPORT */
#if defined(RTC_TAMPER3_SUPPORT)
#define LL_RTC_TAMPER_ACTIVELEVEL_TAMP3                                                                        \
    RTC_TAMPCR_TAMP3TRG /*!< RTC_TAMP3 input falling edge (if TAMPFLT = 00) or staying high (if TAMPFLT != 00) \
                           triggers a tamper detection event*/
#endif                  /* RTC_TAMPER3_SUPPORT */
/**
 * @}
...
#define LL_RTC_WAKEUPCLOCK_CKSPRE_WUT \
    (RTC_CR_WUCKSEL_2 |               \
     RTC_CR_WUCKSEL_1) /*!< ck_spre (usually 1 Hz) clock is selected and 2exp16 is added to the WUT counter value*/
/**
 * @}
 */
...
#define LL_RTC_CALIB_INSERTPULSE_SET                                                                                   \
    RTC_CALR_CALP /*!< One RTCCLK pulse is effectively inserted every 2exp11 pulses (frequency increased by 488.5 ppm) \
                   */
/**
 * @}
 */
...
#define LL_RTC_BINARY_MIX_BCDU_1 \
    (0x1UL << RTC_ICSR_BCDU_Pos) /*!<  1s calendar increment is generated each time SS[8:0] = 0 */
#define LL_RTC_BINARY_MIX_BCDU_2 \
    (0x2UL << RTC_ICSR_BCDU_Pos) /*!<  1s calendar increment is generated each time SS[9:0] = 0 */
#define LL_RTC_BINARY_MIX_BCDU_3 \
    (0x3UL << RTC_ICSR_BCDU_Pos) /*!<  1s calendar increment is generated each time SS[10:0] = 0 */
#define LL_RTC_BINARY_MIX_BCDU_4 \
    (0x4UL << RTC_ICSR_BCDU_Pos) /*!<  1s calendar increment is generated each time SS[11:0] = 0 */
#define LL_RTC_BINARY_MIX_BCDU_5 \
    (0x5UL << RTC_ICSR_BCDU_Pos) /*!<  1s calendar increment is generated each time SS[12:0] = 0 */
#define LL_RTC_BINARY_MIX_BCDU_6 \
    (0x6UL << RTC_ICSR_BCDU_Pos) /*!<  1s calendar increment is generated each time SS[13:0] = 0 */
#define LL_RTC_BINARY_MIX_BCDU_7 \
    (0x7UL << RTC_ICSR_BCDU_Pos) /*!<  1s calendar increment is generated each time SS[14:0] = 0 */
/**
 * @}
 */
#endif /* #if defined (STM32L4P5xx) || defined (STM32L4Q5xx) */
...
LL_RTC_TIME_Config(RTC_TypeDef* RTCx, uint32_t Format12_24, uint32_t Hours, uint32_t Minutes, uint32_t Seconds)
{
    uint32_t temp = 0U;
 ...
 */
__STATIC_INLINE void
LL_RTC_DATE_Config(RTC_TypeDef* RTCx, uint32_t WeekDay, uint32_t Day, uint32_t Month, uint32_t Year)
{
    uint32_t temp = 0U;
 ...
 */
__STATIC_INLINE void
LL_RTC_ALMA_ConfigTime(RTC_TypeDef* RTCx, uint32_t Format12_24, uint32_t Hours, uint32_t Minutes, uint32_t Seconds)
{
    uint32_t temp = 0U;
 ...
 */
__STATIC_INLINE void
LL_RTC_ALMB_ConfigTime(RTC_TypeDef* RTCx, uint32_t Format12_24, uint32_t Hours, uint32_t Minutes, uint32_t Seconds)
{
    uint32_t temp = 0U;
