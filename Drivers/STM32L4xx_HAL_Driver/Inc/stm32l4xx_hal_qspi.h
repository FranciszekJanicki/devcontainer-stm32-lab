...
typedef struct {
    ...
    uint32_t
        AlternateBytes;          /* Specifies the Alternate Bytes to be sent (Size from 1 to 4 bytes according
...
HAL_StatusTypeDef HAL_QSPI_AutoPolling(QSPI_HandleTypeDef* hqspi,
                                       ...
                                       uint32_t Timeout);
HAL_StatusTypeDef
HAL_QSPI_AutoPolling_IT(QSPI_HandleTypeDef* hqspi, QSPI_CommandTypeDef* cmd, QSPI_AutoPollingTypeDef* cfg);

/* QSPI memory-mapped mode */
HAL_StatusTypeDef
HAL_QSPI_MemoryMapped(QSPI_HandleTypeDef* hqspi, QSPI_CommandTypeDef* cmd, QSPI_MemoryMappedTypeDef* cfg);
