...
#define DAC_REG_DHR12R2_REGOFFSET \
    0x30000000U /* Register offset of DHR12Rx channel 2 versus DHR12Rx channel 1 (shifted left of 28 bits) */
...
#define DAC_REG_DOR2_REGOFFSET \
    0x00000020U /* Register offset of DORx channel 1 versus DORx channel 2 (shifted left of 5 bits) */
...
#define DAC_REG_SHSR2_REGOFFSET \
    0x00000040U /* Register offset of SHSRx channel 1 versus SHSRx channel 2 (shifted left of 6 bits) */
...
#define DAC_REG_DHR12RX_REGOFFSET_BITOFFSET_POS                                                                    \
    28U /* Position of bits register offset of DHR12Rx channel 1 or 2 versus DHR12Rx channel 1 (shifted left of 28 \
           bits) */
...
#define DAC_REG_DORX_REGOFFSET_BITOFFSET_POS \
    5U /* Position of bits register offset of DORx channel 1 or 2 versus DORx channel 1 (shifted left of 5 bits) */
#define DAC_REG_SHSRX_REGOFFSET_BITOFFSET_POS \
    6U /* Position of bits register offset of SHSRx channel 1 or 2 versus SHSRx channel 1 (shifted left of 6 bits) */
...
typedef struct {
    ...
    uint32_t WaveAutoGenerationConfig; /*!< Set the waveform automatic generation mode for the selected DAC channel.
                                          ...
                                          discarded.
                                            ...
                                            This feature can be modified afterwards using unitary function @ref
                                          LL_DAC_SetWaveNoiseLFSR(), @ref LL_DAC_SetWaveTriangleAmplitude() depending on
                                          the wave automatic generation selected. */
    ...
    uint32_t
        OutputMode; /*!< Set the output mode normal or sample-and-hold for the selected DAC channel.
...
#define LL_DAC_CHANNEL_1                                                                                        \
    (DAC_REG_SHSR1_REGOFFSET | DAC_REG_DOR1_REGOFFSET | DAC_REG_DHR12R1_REGOFFSET | DAC_REG_DHR12L1_REGOFFSET | \
     DAC_REG_DHR8R1_REGOFFSET | DAC_CR_CH1_BITOFFSET | DAC_SWTR_CH1) /*!< DAC channel 1 */
#if defined(DAC_CHANNEL2_SUPPORT)
#define LL_DAC_CHANNEL_2                                                                                        \
    (DAC_REG_SHSR2_REGOFFSET | DAC_REG_DOR2_REGOFFSET | DAC_REG_DHR12R2_REGOFFSET | DAC_REG_DHR12L2_REGOFFSET | \
 ...
 * @brief    High frequency interface mode defines that can be used with LL_DAC_SetHighFrequencyMode and
...
#define LL_DAC_HIGH_FREQ_MODE_ABOVE_80MHZ \
    (DAC_CR_HFSEL) /*!< High frequency interface mode compatible to AHB>80MHz enabled */
/**
 * @}
 */
...
#define LL_DAC_TRIG_EXT_TIM4_TRGO \
    (DAC_CR_TSEL1_1 | DAC_CR_TSEL1_0)              /*!< DAC channel conversion trigger from external IP: TIM4 TRGO. */
...
#define LL_DAC_TRIG_EXT_TIM6_TRGO \
    (DAC_CR_TSEL1_2 | DAC_CR_TSEL1_0) /*!< DAC channel conversion trigger from external IP: TIM6 TRGO. */
#define LL_DAC_TRIG_EXT_TIM7_TRGO \
    (DAC_CR_TSEL1_2 | DAC_CR_TSEL1_1) /*!< DAC channel conversion trigger from external IP: TIM7 TRGO. */
...
#define LL_DAC_TRIG_EXT_LPTIM1_OUT     \
    (DAC_CR_TSEL1_3 | DAC_CR_TSEL1_1 | \
     DAC_CR_TSEL1_0) /*!< DAC channel conversion trigger from external IP: LPTIM1 TRGO. */
#define LL_DAC_TRIG_EXT_LPTIM2_OUT \
    (DAC_CR_TSEL1_3 | DAC_CR_TSEL1_2) /*!< DAC channel conversion trigger from external IP: LPTIM2 TRGO. */
#define LL_DAC_TRIG_EXT_EXTI_LINE9     \
    (DAC_CR_TSEL1_3 | DAC_CR_TSEL1_2 | \
     DAC_CR_TSEL1_0) /*!< DAC channel conversion trigger from external IP: external interrupt line 9.  */
...
#define LL_DAC_OUTPUT_MODE_SAMPLE_AND_HOLD                                                                           \
    (DAC_MCR_MODE1_2) /*!< The selected DAC channel output is on mode sample-and-hold. Mode sample-and-hold requires \
                         an external capacitor, refer to description of function @ref LL_DAC_ConfigOutput() or @ref  \
...
#define LL_DAC_OUTPUT_BUFFER_DISABLE                                                                                 \
    (DAC_MCR_MODE1_1) /*!< The selected DAC channel output is not buffered: lower drive current capability, but also \
...
#define LL_DAC_OUTPUT_CONNECT_INTERNAL                                                                                \
    (DAC_MCR_MODE1_0) /*!< The selected DAC channel output is connected to on-chip peripherals via internal paths. On \
                         this STM32 series, output connection depends on output mode (normal or sample and hold) and  \
                         output buffer state. Refer to comments of function @ref LL_DAC_SetOutputConnection(). */
/**
 * @}
 */
...
#define LL_DAC_DELAY_STARTUP_VOLTAGE_SETTLING_US                                                                     \
    8U /*!< Delay for DAC channel voltage settling time from DAC channel startup (transition from disable to enable) \
        */
...
#else
#define __LL_DAC_DECIMAL_NB_TO_CHANNEL(__DECIMAL_NB__) (((__DECIMAL_NB__) == 1U) ? (LL_DAC_CHANNEL_1) : (0U))
#endif /* DAC_CHANNEL2_SUPPORT */
...
LL_DAC_SetWaveTriangleAmplitude(DAC_TypeDef* DACx, uint32_t DAC_Channel, uint32_t TriangleAmplitude)
{
    MODIFY_REG(DACx->CR,
               DAC_CR_MAMP1 << (DAC_Channel & DAC_CR_CHX_BITOFFSET_MASK),
...
{
    __IO uint32_t* preg = __DAC_PTR_REG_OFFSET(DACx->SHSR1,
...
{
    __IO uint32_t const* preg = __DAC_PTR_REG_OFFSET(DACx->SHSR1,
                                                     (DAC_Channel >> DAC_REG_SHSRX_REGOFFSET_BITOFFSET_POS) &
                                                         DAC_REG_SHSRX_REGOFFSET_MASK_POSBIT0);
...
__STATIC_INLINE uint32_t LL_DAC_DMA_GetRegAddr(DAC_TypeDef* DACx, uint32_t DAC_Channel, uint32_t Register)
{
    ...
    return (
        (uint32_t)(__DAC_PTR_REG_OFFSET((DACx)->DHR12R1,
...
{
    __IO uint32_t* preg = __DAC_PTR_REG_OFFSET(DACx->DHR12R1,
 ...
 */
__STATIC_INLINE void
LL_DAC_ConvertDualData12RightAligned(DAC_TypeDef* DACx, uint32_t DataChannel1, uint32_t DataChannel2)
{
 ...
 */
__STATIC_INLINE void
LL_DAC_ConvertDualData12LeftAligned(DAC_TypeDef* DACx, uint32_t DataChannel1, uint32_t DataChannel2)
{
 ...
 */
__STATIC_INLINE void
LL_DAC_ConvertDualData8RightAligned(DAC_TypeDef* DACx, uint32_t DataChannel1, uint32_t DataChannel2)
{
...
{
    __IO uint32_t const* preg = __DAC_PTR_REG_OFFSET(DACx->DOR1,
