...
#define SDMMC_STATIC_FLAGS                                                                              \
    ((uint32_t)(SDMMC_FLAG_CCRCFAIL | SDMMC_FLAG_DCRCFAIL | SDMMC_FLAG_CTIMEOUT | SDMMC_FLAG_DTIMEOUT | \
                ...
                SDMMC_FLAG_BUSYD0END | SDMMC_FLAG_SDIOIT | SDMMC_FLAG_ACKFAIL | SDMMC_FLAG_ACKTIMEOUT | \
                SDMMC_FLAG_VSWEND | SDMMC_FLAG_CKSTOP | SDMMC_FLAG_IDMATE | SDMMC_FLAG_IDMABTC))
