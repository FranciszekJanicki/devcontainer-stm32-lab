...
typedef struct {
    ...
    uint32_t
        BitRatePrescaler; /*!< Specifies the SWPMI bitrate prescaler.
 ...
 * @{
 */
#define LL_SWPMI_VOLTAGE_CLASS_C \
    ((uint32_t)0x00000000) /*!< SWPMI_IO uses directly VDD voltage to operate in class C          */
#define LL_SWPMI_VOLTAGE_CLASS_B \
    SWPMI_OR_CLASS /*!< SWPMI_IO uses an internal voltage regulator to operate in class B */
/**
 * @}
 */
