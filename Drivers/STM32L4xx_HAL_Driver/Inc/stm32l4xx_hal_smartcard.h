 ...
 */
#define IS_SMARTCARD_NACK(__NACK__) (((__NACK__) == SMARTCARD_NACK_ENABLE) || ((__NACK__) == SMARTCARD_NACK_DISABLE))
...
HAL_StatusTypeDef
HAL_SMARTCARD_Transmit(SMARTCARD_HandleTypeDef* hsmartcard, const uint8_t* pData, uint16_t Size, uint32_t Timeout);
HAL_StatusTypeDef
HAL_SMARTCARD_Receive(SMARTCARD_HandleTypeDef* hsmartcard, uint8_t* pData, uint16_t Size, uint32_t Timeout);
