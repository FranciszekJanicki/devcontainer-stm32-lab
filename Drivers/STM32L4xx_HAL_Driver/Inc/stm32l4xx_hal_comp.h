...
typedef enum {
    ...
    HAL_COMP_STATE_RESET_LOCKED =
        (HAL_COMP_STATE_RESET | COMP_STATE_BITFIELD_LOCK), /*!< COMP not yet initialized and configuration is locked */
    HAL_COMP_STATE_READY = 0x01U,                          /*!< COMP initialized and ready for use                   */
    HAL_COMP_STATE_READY_LOCKED =
        (HAL_COMP_STATE_READY | COMP_STATE_BITFIELD_LOCK), /*!< COMP initialized but configuration is locked         */
    HAL_COMP_STATE_BUSY = 0x02U,                           /*!< COMP is running                                      */
    HAL_COMP_STATE_BUSY_LOCKED =
        (HAL_COMP_STATE_BUSY | COMP_STATE_BITFIELD_LOCK) /*!< COMP is running and configuration is locked          */
...
#define COMP_WINDOWMODE_DISABLE                            \
    (0x00000000UL) /*!< Window mode disable: Comparators   \
                        instances pair COMP1 and COMP2 are \
                        independent */
#define COMP_WINDOWMODE_COMP1_INPUT_PLUS_COMMON                       \
    (COMP_CSR_WINMODE) /*!< Window mode enable: Comparators instances \
...
#define COMP_INPUT_PLUS_IO1 \
    (0x00000000UL) /*!< Comparator input plus connected to IO1 (pin PC5 for COMP1, pin PB4 for COMP2) */
#define COMP_INPUT_PLUS_IO2 \
    (COMP_CSR_INPSEL_0) /*!< Comparator input plus connected to IO2 (pin PB2 for COMP1, pin PB6 for COMP2) */
#if defined(COMP_CSR_INPSEL_1)
#define COMP_INPUT_PLUS_IO3 \
    (COMP_CSR_INPSEL_1) /*!< Comparator input plus connected to IO3 (pin PA1 for COMP1, pin PA3 for COMP2) */
#endif
/**
 * @}
 */
...
#define COMP_INPUT_MINUS_1_4VREFINT \
    (COMP_CSR_SCALEN | COMP_CSR_BRGEN) /*!< Comparator input minus connected to 1/4 VrefInt */
...
#define COMP_INPUT_MINUS_DAC1_CH1 \
    (COMP_CSR_INMSEL_2) /*!< Comparator input minus connected to DAC1 channel 1 (DAC_OUT1) */
#if defined(DAC_CHANNEL2_SUPPORT)
#define COMP_INPUT_MINUS_DAC1_CH2 \
    (COMP_CSR_INMSEL_2 | COMP_CSR_INMSEL_0) /*!< Comparator input minus connected to DAC1 channel 2 (DAC_OUT2) */
#endif                                      /* DAC_CHANNEL2_SUPPORT */
#define COMP_INPUT_MINUS_IO1 \
    (COMP_CSR_INMSEL_2 |     \
     COMP_CSR_INMSEL_1) /*!< Comparator input minus connected to IO1 (pin PB1 for COMP1, pin PB3 for COMP2) */
#define COMP_INPUT_MINUS_IO2                 \
    (COMP_CSR_INMSEL_2 | COMP_CSR_INMSEL_1 | \
     COMP_CSR_INMSEL_0) /*!< Comparator input minus connected to IO2 (pin PC4 for COMP1, pin PB7 for COMP2) */
#if defined(COMP_CSR_INMESEL_1)
#define COMP_INPUT_MINUS_IO3                                      \
    (COMP_CSR_INMESEL_0 | COMP_CSR_INMSEL_2 | COMP_CSR_INMSEL_1 | \
     COMP_CSR_INMSEL_0) /*!< Comparator input minus connected to IO3 (pin PA0 for COMP1, pin PA2 for COMP2) */
#define COMP_INPUT_MINUS_IO4                                      \
    (COMP_CSR_INMESEL_1 | COMP_CSR_INMSEL_2 | COMP_CSR_INMSEL_1 | \
     COMP_CSR_INMSEL_0) /*!< Comparator input minus connected to IO4 (pin PA4 for COMP1, pin PA4 for COMP2) */
#define COMP_INPUT_MINUS_IO5                                                           \
    (COMP_CSR_INMESEL_1 | COMP_CSR_INMESEL_0 | COMP_CSR_INMSEL_2 | COMP_CSR_INMSEL_1 | \
     COMP_CSR_INMSEL_0) /*!< Comparator input minus connected to IO5 (pin PA5 for COMP1, pin PA5 for COMP2) */
...
#define COMP_OUTPUTPOL_NONINVERTED                                                                               \
    (0x00000000UL) /*!< COMP output level is not inverted (comparator output is high when the input plus is at a \
                      higher voltage than the input minus) */
#define COMP_OUTPUTPOL_INVERTED                                                                                       \
    (COMP_CSR_POLARITY) /*!< COMP output level is inverted     (comparator output is low  when the input plus is at a \
                           higher voltage than the input minus) */
/**
 * @}
 */
...
#define COMP_BLANKINGSRC_TIM1_OC5_COMP1 \
    (COMP_CSR_BLANKING_0) /*!< Comparator output blanking source TIM1 OC5 (specific to COMP instance: COMP1) */
#define COMP_BLANKINGSRC_TIM2_OC3_COMP1 \
    (COMP_CSR_BLANKING_1) /*!< Comparator output blanking source TIM2 OC3 (specific to COMP instance: COMP1) */
#define COMP_BLANKINGSRC_TIM3_OC3_COMP1 \
    (COMP_CSR_BLANKING_2) /*!< Comparator output blanking source TIM3 OC3 (specific to COMP instance: COMP1) */
#define COMP_BLANKINGSRC_TIM3_OC4_COMP2 \
    (COMP_CSR_BLANKING_0) /*!< Comparator output blanking source TIM3 OC4 (specific to COMP instance: COMP2) */
#define COMP_BLANKINGSRC_TIM8_OC5_COMP2 \
    (COMP_CSR_BLANKING_1) /*!< Comparator output blanking source TIM8 OC5 (specific to COMP instance: COMP2) */
#define COMP_BLANKINGSRC_TIM15_OC1_COMP2 \
    (COMP_CSR_BLANKING_2) /*!< Comparator output blanking source TIM15 OC1 (specific to COMP instance: COMP2) */
/**
 * @}
 */
...
#define COMP_TRIGGERMODE_IT_RISING                                                                         \
    (COMP_EXTI_IT | COMP_EXTI_RISING) /*!< Comparator output triggering External Interrupt Line event with \
                                         interruption, on rising edge */
#define COMP_TRIGGERMODE_IT_FALLING                                                                         \
    (COMP_EXTI_IT | COMP_EXTI_FALLING) /*!< Comparator output triggering External Interrupt Line event with \
                                          interruption, on falling edge */
#define COMP_TRIGGERMODE_IT_RISING_FALLING                                                                         \
    (COMP_EXTI_IT | COMP_EXTI_RISING |                                                                             \
     COMP_EXTI_FALLING) /*!< Comparator output triggering External Interrupt Line event with interruption, on both \
                           rising and falling edges */
#define COMP_TRIGGERMODE_EVENT_RISING                                                                                  \
    (COMP_EXTI_EVENT | COMP_EXTI_RISING) /*!< Comparator output triggering External Interrupt Line event only (without \
                                            interruption), on rising edge */
#define COMP_TRIGGERMODE_EVENT_FALLING                                                                         \
    (COMP_EXTI_EVENT | COMP_EXTI_FALLING) /*!< Comparator output triggering External Interrupt Line event only \
                                             (without interruption), on falling edge */
#define COMP_TRIGGERMODE_EVENT_RISING_FALLING                                                                        \
    (COMP_EXTI_EVENT | COMP_EXTI_RISING |                                                                            \
     COMP_EXTI_FALLING) /*!< Comparator output triggering External Interrupt Line event only (without interruption), \
...
#define IS_COMP_WINDOWMODE(__WINDOWMODE__) \
    (((__WINDOWMODE__) == COMP_WINDOWMODE_DISABLE) || ((__WINDOWMODE__) == COMP_WINDOWMODE_COMP1_INPUT_PLUS_COMMON))
#endif /* COMP2 */

#define IS_COMP_POWERMODE(__POWERMODE__)                                                                 \
    (((__POWERMODE__) == COMP_POWERMODE_HIGHSPEED) || ((__POWERMODE__) == COMP_POWERMODE_MEDIUMSPEED) || \
...
#define IS_COMP_INPUT_MINUS(__COMP_INSTANCE__, __INPUT_MINUS__)                                                  \
    (((__INPUT_MINUS__) == COMP_INPUT_MINUS_1_4VREFINT) || ((__INPUT_MINUS__) == COMP_INPUT_MINUS_1_2VREFINT) || \
     ...
     ((__INPUT_MINUS__) == COMP_INPUT_MINUS_DAC1_CH1) || ((__INPUT_MINUS__) == COMP_INPUT_MINUS_DAC1_CH2) ||     \
     ((__INPUT_MINUS__) == COMP_INPUT_MINUS_IO1) || ((__INPUT_MINUS__) == COMP_INPUT_MINUS_IO2) ||               \
     ((__INPUT_MINUS__) == COMP_INPUT_MINUS_IO3) || ((__INPUT_MINUS__) == COMP_INPUT_MINUS_IO4) ||               \
     ((__INPUT_MINUS__) == COMP_INPUT_MINUS_IO5))
#elif defined(COMP_CSR_INMESEL_1)
#define IS_COMP_INPUT_MINUS(__COMP_INSTANCE__, __INPUT_MINUS__)                                                  \
    (((__INPUT_MINUS__) == COMP_INPUT_MINUS_1_4VREFINT) || ((__INPUT_MINUS__) == COMP_INPUT_MINUS_1_2VREFINT) || \
     ((__INPUT_MINUS__) == COMP_INPUT_MINUS_3_4VREFINT) || ((__INPUT_MINUS__) == COMP_INPUT_MINUS_VREFINT) ||    \
     ((__INPUT_MINUS__) == COMP_INPUT_MINUS_DAC1_CH1) || ((__INPUT_MINUS__) == COMP_INPUT_MINUS_IO1) ||          \
     ((__INPUT_MINUS__) == COMP_INPUT_MINUS_IO2) || ((__INPUT_MINUS__) == COMP_INPUT_MINUS_IO3) ||               \
     ((__INPUT_MINUS__) == COMP_INPUT_MINUS_IO4) || ((__INPUT_MINUS__) == COMP_INPUT_MINUS_IO5))
...
#define IS_COMP_HYSTERESIS(__HYSTERESIS__)                                                      \
    (((__HYSTERESIS__) == COMP_HYSTERESIS_NONE) || ((__HYSTERESIS__) == COMP_HYSTERESIS_LOW) || \
     ((__HYSTERESIS__) == COMP_HYSTERESIS_MEDIUM) || ((__HYSTERESIS__) == COMP_HYSTERESIS_HIGH))
