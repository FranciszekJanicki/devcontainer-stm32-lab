...
typedef struct {
    ...
    uint32_t
        HSI48CalibrationValue; /*!< Specifies a user-programmable trimming value to the HSI48 oscillator.
                                  This parameter must be a number between 0 and 0x7F for STM32L412xx/L422xx, between 0
                                  and 0x3F otherwise, or a value of @ref RCCEx_CRS_HSI48CalibrationDefault */
...
typedef struct {
    ...
    uint32_t HSI48CalibrationValue; /*!< Specifies value loaded in HSI48 oscillator smooth trimming.
                                       This parameter must be a number between 0 and 0x7F for STM32L412xx/L422xx,
    ...
    uint32_t FreqErrorDirection; /*!< Specifies the value loaded in the .FEDIR, the counting direction of the
                                                                   frequency error counter latched in the time of the
                                   last SYNC event. It shows whether the actual frequency is below or above the target.
...
#define RCC_PERIPHCLOCK_ALL                                                                                        \
    (RCC_PERIPHCLK_USART1 | RCC_PERIPHCLK_USART2 | RCC_PERIPHCLK_USART3 | RCC_PERIPHCLK_UART4 |                    \
     ...
     RCC_PERIPHCLK_LPTIM1 | RCC_PERIPHCLK_LPTIM2 | RCC_PERIPHCLK_SAI1 | RCC_PERIPHCLK_ADC | RCC_PERIPHCLK_DFSDM1 | \
