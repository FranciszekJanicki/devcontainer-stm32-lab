 ...
 * @{
 */
#define ADC_DFSDM_MODE_DISABLE                              \
    (0x00000000UL) /*!< ADC conversions are not transferred \
by DFSDM. */
#define ADC_DFSDM_MODE_ENABLE                                                   \
    (LL_ADC_REG_DFSDM_TRANSFER_ENABLE) /*!< ADC conversion data are transferred \
...
#define ADC_CLEAR_COMMON_CONTROL_REGISTER(__HANDLE__)                                                          \
    CLEAR_BIT(__LL_ADC_COMMON_INSTANCE((__HANDLE__)->Instance)->CCR,                                           \
              ADC_CCR_CKMODE | ADC_CCR_PRESC | ADC_CCR_VBATEN | ADC_CCR_TSEN | ADC_CCR_VREFEN | ADC_CCR_MDMA | \
